...
resource "aws_eks_node_group" "private_nodes_1" {
  node_group_name = var.aws_eks_node_group_name_one
...
resource "aws_eks_node_group" "private_nodes_2" {
  node_group_name = var.aws_eks_node_group_name_two
  cluster_name    = aws_eks_cluster.demo.name
  node_role_arn   = aws_iam_role.nodes.arn
